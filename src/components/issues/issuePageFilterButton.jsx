...
const getPageCountInStatus = (issue, status) => {
  if (issue && issue.pageStatus) {
    const stat = issue.pageStatus.find((s) => s.status === status);
...
const IssuePageFilterButton = ({
  issue, statusFilter, assignmentFilter, onChange,
}) => {
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {getPageCountInStatus(issue, PageStatus.AvailableForTyping)}
          </Typography>
        </MenuItem>
        <MenuItem
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {getPageCountInStatus(issue, PageStatus.Typing)}
          </Typography>
        </MenuItem>
        <MenuItem
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {getPageCountInStatus(issue, PageStatus.Typed)}
          </Typography>
        </MenuItem>
        <MenuItem
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {getPageCountInStatus(issue, PageStatus.InReview)}
          </Typography>
        </MenuItem>
        <MenuItem
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {getPageCountInStatus(issue, PageStatus.Completed)}
          </Typography>
        </MenuItem>
      </Menu>
    </>
...
IssuePageFilterButton.defaultProps = {
  issue: null,
...
IssuePageFilterButton.propTypes = {
...
export default IssuePageFilterButton;
