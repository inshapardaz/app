...
const useStyles = makeStyles({
	banner : {
		backgroundImage : 'linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url("/images/categories_background.jpg")',
...
const CategoriesBanner = ({ title, subTitle, createLink, onCreate }) =>
{
