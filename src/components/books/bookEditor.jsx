...
const BookEditor = ({ show, book, createLink, onSaved, onCancelled }) => {
  ...
  const handleImageUpload = (files) => {
    ...
    if (book && book.links.image_upload !== null) {
      libraryService
        .upload(book.links.image_upload, files[0])
        .then(() => onSaved())
        .catch(() => setError(true))
        .finally(() => setBusy(false));
    }
      ...
      <DialogContent>
          ...
          <Grid item sm={8} xs={12}>
            <TextField
              ...
              label={intl.formatMessage({
                id: "book.editor.fields.name.title",
              })}
            ...
            <TextField
              ...
              label={intl.formatMessage({
                id: "book.editor.fields.description.title",
              })}
              fullWidth
              multiline
            ...
            <AuthorDropDown
              ...
              margin="normal"
              label={intl.formatMessage({
                id: "book.editor.fields.author.title",
              })}
            ...
            <CategoriesDropDown
              ...
              fullWidth
              label={intl.formatMessage({
                id: "book.editor.fields.categories.title",
              })}
              value={categories}
            ...
            <TextField
              ...
              type="number"
              label={intl.formatMessage({
                id: "book.editor.fields.yearPublished.title",
              })}
            ...
            <FormControl fullWidth>
              <InputLabel>
                {intl.formatMessage({
                  id: "book.editor.fields.language.title",
                })}
              </InputLabel>
              <LanguageDropDown
                fullWidth
            ...
            <FormControl fullWidth>
              <InputLabel>
                {intl.formatMessage({ id: "book.editor.fields.series.title" })}
              </InputLabel>
              <SeriesDropDown
                fullWidth
                id="series"
            ...
            <TextField
              ...
              margin="normal"
              label={intl.formatMessage({
                id: "book.editor.fields.seriesIndex.title",
              })}
            ...
            <FormControl fullWidth>
              <InputLabel>
                {intl.formatMessage({
                  id: "book.editor.fields.copyrights.title",
                })}
              </InputLabel>
              <CopyrightDropDown
                fullWidth
        ...
        {error && (
          <Alert severity="error">
            <FormattedMessage id="books.messages.error.saving" />
          </Alert>
        )}
      </DialogContent>
    </Dialog>
